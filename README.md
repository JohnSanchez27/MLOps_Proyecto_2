...
Sin embargo, no fue posible establecer conexión con el endpoint http://10.43.101.108:80/data?group_number=7 desde la máquina virtual utilizada en este proyecto. Por tal motivo, optamos por ejecutar los procesos de forma local con el objetivo de verificar el funcionamiento correcto del flujo de la aplicación. Esta ejecución local nos permitió generar un entorno de desarrollo adecuado para continuar con las pruebas y ajustes necesarios de las conexiones. 